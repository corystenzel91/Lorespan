...
const CACHE_NAME="lorespan-v8.6.4";
const CORE=[
  "./",
  "./index.html",
  "./offline.html",
  "./manifest.webmanifest",
  "./library-concept-shelf-v864.webp",
  "./lorespan-desk-room-v864.webp",
  ...
  "./library-hero.png",
  "./lorespan-home.webp",
  "./cover-vantheir-clean-v864.webp",
  "./cover-hero-academia-v864.webp",
  "./cover-beastbound-clean-v864.webp",
  "./cover-tides-clean-v864.webp",
  "./cover-guild-clean-v864.webp",
  "./cover-starfall-v864.webp",
  "./cover-moonwake-v864.webp",
  "./cover-emberwake-v864.webp",
  "./cover-ironhaven-v864.webp",
  "./cover-veilwood-v864.webp"
];
