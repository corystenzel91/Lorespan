const CACHE_NAME = "lorespan-v8.5.8";
const CORE = [
  "./", "./index.html", "./offline.html",
  "./lorespan-desk-room-v858.webp", "./manifest.webmanifest", "./magic-book-192-v2.png", "./magic-book-512.png",
  "./magic-book-maskable-192.png", "./magic-book-maskable-512.png", "./hero-top-blue-book.webp", "./library-hero.png", "./library-concept-shelf-v858.webp",
...
self.addEventListener("install", event => {
  ...
  "./lorespan-desk-room-v858.webp","./manifest.webmanifest"];
