...
### v8.9.20 animation fix
The shelf book itself is the only launch target. The cinematic overlay includes a dimensional book model and a Skip Animation button.
